...
fecha: 2026-07-16
fuentes_primarias:
  - "Ley Orgánica de Hidrocarburos (LOH) 2026 (Gaceta 6978 Ext.) — indexada en KB"
...
marco_legal:
  ...
  - "LOH 2026 (Gaceta 6978) — régimen de empresas mixtas"
  - "LOM 2026 (Gaceta 7020) — régimen minero"
  - "LOTEL 2011 + Ley Antibloqueo 2020"
  - "Nueva Ley Orgánica del Régimen de Adquisición Forzosa de Acciones de Empresas Estratégicas (LORAFEE, Doc. 5 Título IV)"
  - "Nueva Ley Orgánica de Banca de Desarrollo y Mercado de Capitales (LOBMC) — propuesta"
  - "Nueva Ley Orgánica de Régimen de Privatización de Servicios Públicos (LORPSP) — propuesta"
referentes_principales:
  - "Noruega: GPFG (Government Pension Fund Global) + Statoil/Equinor + modelo de participación estatal mayoritaria con listing bursátil"
  - "Singapur: Temasek Holdings + GIC + Directorship lnking con disciplina de mercado + Civil Service College para cuadros"
  - "Arabia Saudita: Saudi Aramco listing 2019 (referencia OPI)"
  - "Brasil: Petrobras listing 2010 + pre-sal governance"
...
|---|---|
| Producción de crudo | ~0,8-0,9 MM bpd (vs 3,5 MM bpd potencial histórico) |
| Reservas probadas | ~300.000 MM bbl (las mayores del mundo) |
| Recaudación no petroleta | ~6% PIB (vs 17% Chile, 21% Colombia, 23% Uruguay) |
| Dependencia fiscal del petróleo | ~50% ingresos fiscales |
...
- **Mes 0-3**: selección del banco de inversión internacional (licitación pública entre las cinco top-tier globales) + due-diligence técnica para certificación de reservas probadas conforme al esquema SPE-PRMS.
- **Mes 3-6**: *road-show* a principales fondos soberanos (Norwegian GPFG, GIC Singapur, ADIA Abu Dhabi, Temasek, Mubadala, PIF Saudi), fondos pensión (Norwegian Pension Fund, CalPERS) y fondos ISR (CIF BlackRock, PNB Paribas).
- **Mes 6-9**: book-building. La colocación estratégica busca captar al menos 5-8 anchor investors antes de la OPI pública.
- **Mes 9**: lanzamiento NYSE (primary) + LSE + BVC. Aspirar a valoración de **USD 50-150 MM** por la matriz usando metodología comparada con Aramco (2019), Petrobras (2010) y equivalentes ajustados por calidad de activos.
...
**Implicancia inmediata**: NO requiere reforma de LOH 2026 para que las filiales mixtas (Petrocedeño, Petromonagas, Petroquiriquire) operen bajo nuestro régimen. Basta que el directorio de PDVSA matriz apruebe el listado por filial, sujeto a:
- Aprobación de la AN con **3/5** (mayoría calificada) — vinculado al control público permanente.
...
- **Reversión automática** si el Estado incumple el pago en el plazo: las acciones regresan al accionista privado originario, sin derecho a reclamo estatal, con responsabilidad patrimonial.
...
- El Estado tiene 1 acción especial (independiente del % accionario) con veto en decisiones de reserva estratégica (cambio de sede, fusión con empresa extranjera, transferencia tecnológica sensible).
...
1. **Distribución (5-7 concesionarios)** vía licencias regionales tipo OFGEM/UK.
2. **Transmisión troncal** como operador único bajo régimen de peaje regulado.
3. **Generación** mediante mercado mayorista competitivo.
4. **Rector iluminación**: se mantiene una Dirección General de Energía Eléctrica pequeña (≤ 100 funcionarios), dependiente del Ministerio de Energía, con funciones regulatorias + supervisión de peajes + supervisión del mercado mayorista.

**Régimen 20 años exoneración** (siguiendo el principio ya consolidado del proyecto):
...
- **Tipo 1 — Banca universal**: BIC (entidad primaria) con capital mixto.
- **Tipo 2 — Banca de desarrollo**: 3 entidades según especialización sectorial: FIDE (Fondo de Inversión para el Desarrollo Económico — sustituye FINDE), BANDAES (Banco Nacional para el Desarrollo Agropecuario y Energías Sostenibles), BANMI (Banco Nacional de la Microempresa).
- **Tipo 3 — Casas de valores, fondos mutuales, bolsas de valores**, con **ente regulador unificado** (Superintendencia Nacional de Valores, SNAVALE).
...
- Auditoría externa anual + veeduría CIDH.
...
|---|---|---|
| Decreto de creación del FNIP | Banco de Inversión Productiva | A emitir en Mes 0 |
| Decreto de banda cambiaria mes 1 | Apertura ±15% | A coordinar con BCV |
| Decreto de privatización CANTV | Mes 0 | A emitir |
| Decreto de banca de desarrollo | Mes 0 | A emitir |
...
| # | Indicador | Meta |
|---|-----------|------|
| 1 | OPI PDVSA concluida en NYSE/LSE/BVC | Mes 9 |
| 2 | Ingresos netos OPI PDVSA | ≥ USD 8.000 M |
| 3 | Filiales mixtas listadas en bolsa | ≥ 3 (Petrocedeño, Petromonagas, Petroquiriquire) |
| 4 | Privatización CANTV completada | Mes 6 |
| 5 | Privatización Corpoelec completada (distribución + generación) | Mes 12 |
| 6 | Privatización 9 hidrológicas | Mes 12 |
| 7 | FOSEIP capitalizado | USD 5.000 M en año 3 |
| 8 | FNIP en operación con proyectos co-invertidos | ≥ 5 en año 1, ≥ 30 en año 3 |
| 9 | Recaudación no petroleta como % del PIB | ≥ 14% año 5 |
| 10 | Variación anual de producción PDVSA matriz | ≥ +15% año 1, ≥ +60% año 3 |
...
3. **Devolver o revertir la privatización de Corpoelec, CANTV, hidrológicas regionales**: requiere mayoría **3/4** + referéndum. En caso de reversión de lo ya privatizado, se indemniza conforme a la cláusula pay-before-take aplicada en reverso (justiprecio + 30%).
