---
titulo: Reforma Integral del Estado Venezolano - Sección IV Plan de Implementación (cronograma consolidado 0-36 meses)
parte: Parte IV — Plan de Implementación
version: 0.1
fecha: 2026-07-16
...
recursos_estimados:
  - "OPI PDVSA matriz 49%: USD 8.000-15.000 millones (Mes 9)"
  - "Privatizaciones (CANTV + Corpoelec + 9 HIDROVEN): USD 2.500-5.500 millones (Mes 0-12)"
  - "Captura tributaria + IGTF reemplazado: USD 4.000-8.000 M/año año 2"
...
# IV. Plan de Implementación consolidado · 0-36 meses

> *"No hay plan perfecto que sobreviva a la primera hora de ejecución. Pero un plan razonable ejecutado con disciplina sí sobrevive."*
>
> — Adaptación de Helmuth von Moltke para el contexto venezolano.

Este documento opera como **Sección IV** del proyecto y traduce los 8 pilares de la Parte III en un programa ejecutivo trimestral y consolidado. La estructura replica el patrón de los pilares: diagnóstico → marco normativo → fases → indicadores → riesgos → blindaje constitucional.

## IV.1. Visión general y principios del Plan

### IV.1.1. Objetivo

Operacionalizar la Reforma Integral del Estado Venezolano bajo los principios:
...
### IV.1.2. Marco temporal global (0-36 meses)

```
 Mes 0-12    Mes 12-24    Mes 24-36
┌───────────────────┬──────────────────┬──────────────────┐
│ Fase 1 — Shock     │ Fase 2 — Estabiliz│ Fase 3 — Dolariz. │
│ inicial            │ ación             │ oficial           │
│ ⋅ 6 leyes críticas │ ⋅ Plan Quinquenal│ ⋅ Dolarización    │
│ ⋅ DNU PDVSA        │ ⋅ Plan Plurianual│ ⋅ OPI mercado     │
│ ⋅ CPNP+CICPC+JNEM  │ ⋅ MIED-LAM plann.│ ⋅ Consolidación   │
│ ⋅ OPI PDVSA mes 9  │ ⋅ Privatiz. total │ ⋅ Consolidación   │
└───────────────────┴──────────────────┴──────────────────┘
```
...
PRESIDENTE DE LA REPÚBLICA (voz y voto dirimente)
        │
        ├── Comité de Reforma del Estado (CRE) — máximo órgano
        │       ├── 9 Ministros del nuevo gabinete
        │       │   ├── Interior y Seguridad (CPNP+CICPC+JNEM unificados)
        │       │   ├── Educación (MIED-LAM)
        │       │   ├── Servicio Civil y Función Pública (CNSC)
        │       │   ├── Economía y Finanzas (BCV + FOSEIP + tributaria)
        │       │   ├── Justicia (TSJ meritocrático + Ministerio Público + DNA-RB)
        │       │   ├── Energía y Minas (PDVSA matriz privatizada + filiales)
        │       │   ├── Infraestructura y Servicios (privatizaciones eléctricas +
        │       │   │   agua, CANTV, regulación transporte)
        │       │   ├── Planificación Estratégica (DNPEP)
        │       │   └── Gobierno Digital (BND + VePass + VePass-Mig)
        │       ├── Contralor General (subsistente, art. 288 CRBV)
        │       ├── Presidente del BCV
        │       ├── Presidente del TSJ meritocrático (post Mes 3)
        ...
        └── Sistema de Monitoreo Semanal Presidencial (SMSP)
                ...
                ├── Reunión lunes 7:00 am (90 min)
                ├── Decisiones vinculantes firmadas por Presidente
                └── Veeduría CIDH + OACNUDH coparticipada en seguimiento
```

### IV.2.1. Secretaría Técnica (STCRE)

| Integrante | Cantidad | Perfil |
|---|---|---|
| Director General STCRE | 1 | Concurso CNSC, 6 años único (régimen idéntico a CPNP/CICPC) |
| Coordinadores Mesa | 8 | Por pilar, también por concurso CNSC |
| Especialistas IV | 8 | Técnicos con experiencia internacional comprobada |
| Especialistas III | 6 | Apoyo técnico senior |
| Especialistas II | 4 | Implementación operativa |
| Especialistas I | 3 | Seguimiento y métricas |
| Administrativos | 5 | Apoyo administrativo |

**Total STCRE**: 35 profesionales + soporte administrativo. Presupuesto anualizado: USD 18-22 millones/año.

## IV.3. Fases del Plan de Implementación

### IV.3.1. Fase 0 — Preparatoria (Mes -6 a 0)

Aplica solo si se ejecuta un gobierno de transición antes del "mes 0" oficial.
...
**Leyes orgánicas dictadas en los primeros 90 días (paquete único)**:
...
| Mes | Hito |
|---|---|
| **Mes 0** | Sanción 6 leyes orgánicas + creación FEM, FOSEIP, FNIP + creación STCRE + Decreto de banca de desarrollo + Decreto de privatización CANTV + Decreto banda cambiaria + Veeduría Internacional preliminar activa + Veeduría CIDH + OACNUDH instalada |
| **Mes 1** | Apertura de la banda cambiaria ±15% + eliminación recargo 25% en USD + eliminación IGTF sobre USD + permiso universal de mantener/transar/depositar en USD + Concurso Público BROW Director General CPNP + BROW Director General CICPC + BROW Subdirector Nacional de Migración + BROW Director CNSC + BROW Director DNPEP + BROW Director DNA-RB + BROW Director MIED-LAM (rangos con jurado mixto PNUD+OEA+ACNUR+STCRE) |
| **Mes 2** | Creación del Consejo Anticorrupción Soberano (CAS) + congelamiento de designaciones discrecionales (Decreto Ejecutivo 001) + BROW Tribunales Disciplinarios Preliminares + concurso masivo de ingreso al Cuerpo de Policía Provisional (CPP) para garantizar presencia policial inmediata con VePass-Fuerte obligatoria |
| **Mes 3** | Ratificación por AN 3/5 de los 8 directores + Decreto Ejecutivo 002: sueldo mínimo nacional USD 500 + publicación inmediata del Plan de Implementación + primeras cámaras de TV educativa + inauguración del primer Centro Único de Procesamiento Migratorio (Caracas) + juramento del **CICPC reformado** (Subdirector Nacional de Migración + 8 departamentos operativos) + inicio del RTER para PNB/policiales estadales |
| **Mes 4** | Posesión de 8 Directores Generales + arranque STCRE + Decreto de creación del Comité de Coordinación Interinstitucional (CCNI) + RTER para PNB cobertura regional 25% + inauguración 4 CUPM Caracas/Maracaibo/Puerto Ordaz/San Antonio |
| **Mes 5** | RTER para PNB cobertura regional 50% + concursos masivos de ingreso CPNP con VePass-Fuerte + creación del Registro Único de Inmuebles migratorio (BND-RUI-Mig) + conexión con Interpol SLTD + Alianza ACNUR-FRONTEX UE firmada |
| **Mes 6** | RTER para PNB cobertura regional 75% + sanciones del DNU en marcha (cortes patronales) + RTER para policías estadales + Levantamiento de la Ley Antibloqueo 2020 + arranque de la Selección del Banco de Inversión PDVSA OPI + Ronda de consultas VWAP (vehicular) + Decreto ejecutivo de dolarización con BCV + ampliación del cupo USD en frontera |
| **Mes 7** | RTER para PNB cobertura regional 100% + RTER CICPC + RTER para policías municipales + Veeduría CIDH + OACNUDH emite primer informe trimestral vinculante |
| **Mes 8** | Apertura de la ANSP + Diseño de las 10 regiones operativas del CPNP + Instalación de los VePass-Fuerte en agentes pre-existentes + Ley de la JNEM (extingue SAIME + transfiere funciones al CICPC) + Creación del Departamento de Puntos Migratorios (DNPM) |
| **Mes 9** | Entrada en operaciones de la Dirección Nacional Anticorrupción interna del CPNP + instalación BND-ADN en delegaciones + inicio de la transferencia del personal del SAIME al CICPC/JNEM (RTER especial) + apertura operativa 4 CUPM regionales + **Lanzamiento NYSE/LSE/BVC OPI PDVSA matriz 49% + entrega inicial 49% a anchor investors** + proceso Corpoelec-distribución 5 lotes + Comité de Nominaciones directorio PDVSA designado |
| **Mes 10** | Creación del Tribunal Disciplinario Especializado + entrada en funciones del Ministerio Público unificado + jurado mixto veeduría OACNUDH/CIDH + ratificación AN 3/5 del Director General del CICPC + **Subdirector Nacional de Migración** por concurso CNSC + instalación del CCNI + Cierre del primer ciclo RTER para PNB (publicación de resultados con transparencia regional) + operativa piloto de la JNEM en pasos fronterizos oficiales + Privatización 2da fila de hidrológicas (Hidrolago, Hidroandes, Hidrolara) |
| **Mes 11** | Cambio de uniforme, identidad y dependencia CPNP, operaciones CPNP↔CICPC regionalizadas + arranque Escuela Nacional de Investigación Criminal (3 sedes piloto) + publicación de resultados RTER para policías estadales + operativa plena de la JNEM en pasos fronterizos oficiales y misiones consulares + operativa del DNPM en pasos fronterizos formales restantes (~30) + Privatización 3ra fila de hidrológicas + book-building OPI PDVSA |
| **Mes 12** | Cierre de las policías estadales "antiguas" + integración con VePass-Firma obligatoria activa + CICPC en operaciones con VePass-Firma obligatoria en todas las delegaciones + publicación de resultados RTER para policías municipales + RTER base para CICPC + RTER inicial para personal transferido del SAIME + primer ciclo anual de reexaminación + operativa consolidada de la JNEM con BND-RUI-Mig + puesta en marcha SIM-VE y conexión con Interpol SLTD + ACNUR + FRONTEX UE + Privatización Corpoelec-restantes + Privatización Corpoelec-Generación mercado mayorista + Privatización Solar/fotovoltaica zonal + Privatización Movilnet + Privatización Hidrológicas 4ta fila + **Directorio PDVSA meritocrático instalado (nuevos 13 miembros)** + Hito de **autonomía plena del BCV** + publicación del primer Plan Quinquenal (DNPEP Mes 1) + sanciones II LOPSPP |
...
| Mes | Acción |
|---|---|
| 0-2 | LOSCM (paquete Mes 1-2) + creación CNSC |
| 1-3 | BROW Presidente CNSC |
| 3 | Juramento Presidente CNSC + arranque mesas técnicas pilar I.1 |
| 4-8 | **Concurso masivo de reconversión**. ~30.000 funcionarios preexistentes deben concursar el REquilibra (Régimen de Transición Equilibrado para el Servicio Civil = análogo al RTER para cuerpos de seguridad): 3 exámenes técnicos conforme al nuevo marco meritocrático + verificación patrimonial BND-DNA-RB. |
| 6-12 | REquilibra cobertura regional progresiva + VePass-Fuerte obligatoria para todos los funcionarios en servicio |
...
| Mes | Acción |
|---|---|
| 0-2 | LOCPNP reformada + LORAFEE (paquete Mes 2-3) |
| 1-3 | BROW CPNP + CICPC + JNEM directors |
| 3 | Juramento Directores + creación del CCNI |
| 4-8 | Diseño de las 10 regiones operativas CPNP + Juramento del Subdirector Nacional de Migración + inicio del RTER para PNB/policiales estadales/municipales/CICPC |
| 8 | Apertura de la ANSP + instalación de los VePass-Fuerte en agentes pre-existentes |
| 9-12 | CPNP en operaciones |
...
| Mes | Acción |
|---|---|
| 0-2 | LOMIEDLAM (paquete Mes 1-2) |
| 2-5 | Comisión de Transición del MIED-LAM (ente transitorio fusiona MPPE + MPPDJ) |
| 5-12 | Equipo técnico original + lógica reconversión. Fusión con MPPDJ. Diseño de los 8 programas nacionales |
...
| Mes | Acción |
|---|---|
| 0 | FOSEIP + FNIP + Decreto banca de desarrollo + Decreto privatización CANTV |
| 0-3 | Selección del banco de inversión para OPI PDVSA + proceso de privatización CANTV + privatización 2 hidrológicas |
| 3-6 | Privatización 3 hidrológicas + road-show OPI PDVSA a fondos soberanos |
| 6-9 | Privatización Corpoelec-distribución + book-building OPI PDVSA + Decreto Comité de Nominaciones PDVSA + Privatización CANTV completada + Privatización 3 hidrológicas + Privatización Corpoelec |
| 9 | **LANZAMIENTO NYSE/LSE/BVC OPI PDVSA matriz 49%** (Cronograma crítico) |
| 9-12 | Privatización Corpoelec-restantes + Cuerpoelec-Generación mercado mayorista + Solar/fotovoltaica + Movilnet + Hidrológicas 4ta fila |
| 12 | **Directorio PDVSA meritocrático instalado (13 miembros)** |
...
| Mes | Acción |
|---|---|
| 0-2 | Reforma del TSJ meritocrático + reconformación del Ministerio Público unificado + creación de la DNA-RB |
| 1-3 | BROW Director DNA-RB + BROW Presidente TSJ meritocrático + BROW Fiscal General |
| 3-6 | Reformas en justicia penal + CPIB + Ley Orgánica del Ministerio Público + reforma códigos procesales |
| 6-12 | Carrera fiscal meritocrática + Escuela Nacional de la Judicatura + concursos masivos jueces y fiscales |
...
| 9-12 | Sistema RUP-INR activo + reportes trimestrales públicos del BND + integração BND-ADN operativa + Link SIM-VE operativo |
...
| Mes | Acción |
|---|---|
| 0-2 | LOPSEP (Ley Orgánica de Planificación Estratégica y Prospectiva) derogando LOPSPP 2014 |
| 1-3 | BROW Director General DNPEP + ratificación AN 3/5 |
| 3-9 | Diseño del primer Plan Quinquenal (24 meses elaboración con consulta pública abierta VePass) |
| 9-12 | **Primer Plan Quinquenal aprobado por AN con mayoría absoluta** + publicación + entrada en operación |
| 12-18 | UPE operativa con informes trimestrales vinculantes + presupuesto plurianual vinculante 3 años activado |
| 18-30 | Primera revisión obligatoria al año 3.5 del Plan Quinquenal con ajustes + segunda consulta pública |
| 24-36 | Consolidación DNPEP + rating anual A-D publicado + Plan Quinquenal en ejecución plena + consecución FOSEIP-FEM-Pland Nación |

## IV.5. Indicadores consolidados (KPI Presidencial Semanal)

El **Sistema de Monitoreo Semanal Presidencial (SMSP)** automatiza el seguimiento de 20 KPIs clave:

### IV.5.1. Seguridad y orden (5 KPIs)

| # | KPI | Frecuencia | Meta |
|---|---|---|---|
| 1 | Tasa de muertes violentas /100K (mensual, fuente OVV) | Mensual | -10% acumulado |
| 2 | % de agentes CPNP/CICPC con VePass-Fuerte activa | Mensual | ≥85% desde Mes 9 |
| 3 | Denuncias de tortura verificadas | Mensual | 0 |
| 4 | Detenciones irregulares (cero refoulement JNEM) | Mensual | 0 |
| 5 | Criminalística resuelta con prueba BND-ADN (%) | Mensual | ≥70% año 3 |

### IV.5.2. Integridad institucional (4 KPIs)

| # | KPI | Frecuencia | Meta |
|---|---|---|---|
| 6 | Investigaciones DNA-RB contra funcionarios activas | Trimestral | >0 |
| 7 | Denuncias aprobadas por Defensor del Pueblo meritocrático | Trimestral | n/a |
| 8 | Calificación anual DNPEP del CPNP (Rating A-D) | Anual | B+ |
| 9 | Calificación anual DNPEP del CICPC (Rating A-D) | Anual | B+ |

### IV.5.3. Económica-financiera (5 KPIs)

| # | KPI | Frecuencia | Meta |
|---|---|---|---|
| 10 | Variación mensual de inflación (IPC) | Mensual | <30% año 1 |
| 11 | Reservas BCV (USD MM) | Mensual | >USD 12.000 por Mes 18 |
| 12 | Recaudación tributaria nacional no petroleta (USD MM) | Mensual | ≥USD 1.000 mes 12 |
| 13 | Producción PDVSA matriz (MM bpd) | Mensual | >1.2 año 1; >1.5 año 2 |
| 14 | Capital FOSEIP (USD MM) | Trimestral | >USD 5.000 año 5 |

### IV.5.4. Capital humano (3 KPIs)

| # | KPI | Frecuencia | Meta |
|---|---|---|---|
| 15 | Funcionarios del Estado con concurso público de ingreso | Anual | ≥80% año 3 |
| 16 | Cobertura Proyecto Familia MIED-LAM (% niños 0-6) | Anual | ≥65% año 3 |
| 17 | Desempeño cognitivo promedio (estandarizado) | Anual | +0.3 DT año 3 |

### IV.5.5. Digital y frontera (3 KPIs)

| # | KPI | Frecuencia | Meta |
|---|---|---|---|
| 18 | % venezolanos con VePass activo | Anual | ≥85% año 3 |
| 19 | % extranjeros en territorio con RUI-Mig activo | Anual | ≥80% año 1; ≥95% año 3 |
| 20 | Tiempo medio de inspección migratoria por viajero | Anual | <90 segundos/año 1 |

## IV.6. Riesgos transversales del Plan de Implementación
...
| 13 | **Tasa de aprobación RTER <20%** (colapso orgánico del CPNP) | Baja | Alto | Los concursos CNSC + ANSP producen reemplazos en 15-20 años. **No se relaja el examen**. |
| 14 | **Tasa de aprobación RTER >70%** (sospecha de fraude) | Baja | Alto | OACNUDH/CIDH auditan + congelación + escalamiento a DNA-RB + anulación de nombramientos |
| 15 | **Caos migratorio** por cierre/abertura de pasos formales | Alta | Alto | Plan Fronterizo de Emergencia DNPEP + mesas de diálogo CGN, UNAFA, consejos comunales + transformación progresiva de economía informal a economía regulada |

## IV.7. Presupuesto consolidado (estimación USD/Año)

| Rubro | Año 1 | Año 2 | Año 3 | Año 4-5 |
|---|---:|---:|---:|---:|
| STCRE | 22 M | 22 M | 22 M | 22 M |
| CPNP (incluye RTER, ANSP, VePass) | 4.500 M | 4.500 M | 4.500 M | 4.500 M |
| CICPC (incluye JNEM) | 800 M | 700 M | 700 M | 700 M |
| MIED-LAM (incluye expansión nacional) | 1.500 M | 2.500 M | 3.500 M | 4.500 M |
| DNPEP | 50 M | 50 M | 50 M | 50 M |
| CNSC + STCRE | 50 M | 35 M | 35 M | 35 M |
| DNPEP-A + DNPEP-Evaluación | 200 M | 150 M | 150 M | 150 M |
| CPNP-DNPEP-Plan Quinquenal | 80 M | 80 M | 80 M | 80 M |
| BND + Data Centers + VePass | 800 M | 600 M | 400 M | 200 M |
| FEM | 320 M | 320 M | 320 M | 320 M |
| FOSEIP + FNIP (inversión inicial) | 1.500 M | 500 M | 250 M | 100 M |
| Total operativo | **~9.800 M** | **~9.500 M** | **~10.100 M** | **~10.700 M** |

**Inversión inicial bruta del Estado** (Año 1): USD ~10.000 M, financiada por:

| Fuente | USD Millones | Notas |
|---|---:|---|
| OPI PDVSA (mes 9, una vez) | 8.000-15.000 | Ingreso excepcional |
| Privatizaciones (mes 0-12, acumulado) | 2.500-5.500 | CANTV + Corpoelec + Hidrológicas |
| Reforma tributaria (ingresos recurrentes) | 4.000-8.000 | IVA + ISLR + Impuesto PN + reemplazos IGTF |
| Reestructuración deuda externa | 60.000 M (negociación plurianual) | Reducción de servicio + alargamiento + quita |
| Créditos multilaterales (BID, BM, CAF) | 12.000-18.000 | Acordar Mes -6 a 6 |

## IV.8. Blindaje constitucional del Plan de Implementación
...
6. **Principio *career-only***: modificación de los requisitos = mayoría 3/4 + referéndum.

Estos hitos quedan **encadenados** (art. 5° CF 1958 analogía): quien afecta uno afecta los demás. Cualquier intento de reforma por ley ordinaria, decreto de emergencia económica, ley habilitante o asamblea constituyente debe observar idéntica mayoría 3/4 + referéndum.

## IV.9. Metodología de revisión

El Plan de Implementación se somete a **revisión trimestral general** por el CRE con informes producidos por STCRE + DNPEP + Veeduría Internacional + Auditor Externo. Los hitos críticos pasan por **auditorías independientes contratadas con firmas internacionales**:
...
| BID + BM + CAF | Cumplimiento de los hitos convenidos en reestructuraciones | Trimestral |

Resultados publicados en [dominio público de acceso abierto] anualmente.
...
- **Anexo IV.F**: Manual de diseño de la PNUD-OACNUDH-CIDH-FRONTEX UE-ACNUR para los primeros 36 meses.
- **Anexo IV.G**: Lista de jurisdicciones de cumplimiento Dual Use de OPI PDVSA + protecciones legales.
