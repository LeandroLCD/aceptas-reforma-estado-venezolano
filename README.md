...
**Aceptas** es una propuesta técnica y política de **reforma integral del Estado venezolano**, elaborada durante  el 2026 con metodología de síntesis comparada — Milei arranque, Singapur método, Chile Solidario red de protección — y anclaje en el marco constitucional vigente (Constitución de la República Bolivariana de Venezuela de 1999) sin reforma constituyente. No es un partido. No es un manifiesto ideológico.

Es un **artefacto técnico-legislativo** que comprende:

- **8 pilares orgánicos** (mecanismo central + cláusula de continuidad + procedimiento de reforma reforzado)
- **6 leyes orgánicas nuevas** (LOBCV, LORAFEE, LOPSEP, LOH 2026, LOM 2026, LOPSPP)
- **12 fichas técnicas ministeriales** (9 ministerios del Estado reformado + Consejo Nacional de Defensa + Poder Ciudadano ampliado)
- **1 plan de implementación 0–36 meses** con 100 indicadores clave de desempeño
- **1 comisión ejecutiva de verdad, memoria y reparación** (Comisión Carmen Navas)
- **1 texto articulado** con 17 Títulos y artículos 121-184
- **1 documento final compilatorio** listo para publicación

### Estado reformado resultante

El proyecto se completa con un **Estado reformado de 9 ministerios + 1 ente presidencial de Defensa + 5 instituciones del Poder Ciudadano ampliado**, frente a los 35 ministerios del régimen vigente. Detalle operativo de cada ente en [`fichas-tecnicas/`](fichas-tecnicas/).

---

## Lema y convocatoria

> *"Hay mucha gente que no entiende / Que el gobierno / No es el único que debe cambiar para cambiar este infierno / Aquí hace falta leer y usar los cuadernos / Y reconocer que la juventud no es un don eterno."*
> — *Pa' la Calle*, Canservero

**Aceptas = narrativa fundacional, no partido político.** Quien acepta el proyecto pertenece al colectivo. Quien no acepta está fuera del colectivo Aceptas pero no puede ser excluido como enemigo — la indiferencia ha sido la causa principal de la persistencia del régimen.

### Crítica constitutiva

Aceptas rechaza explícitamente la **oposición angelical**: los "angelitos" que hacen ilusión a políticos vestidos de santos y han contribuído a la permanencia del chavismo. La cláusula de continuidad del proyecto sólo funciona si **el pueblo vigila**, porque sino la mayoría parlamentaria circunstancial la deshace.
...
├── README.md                                      ← este archivo (v2 catálogo exhaustivo)
├── LICENSE                                        CC BY-SA 4.0
│
├── prologo/
│   └── resumen-ejecutivo.md                       ← Punto de entrada (5 minutos)
├── diagnostico/
...
│
├── documento/
│   └── documento-final-v0.1.md                    Documento compilatorio único (publicable)
│
...
|---|---|
| Entender Aceptas en 5 minutos | [`prologo/resumen-ejecutivo.md`](prologo/resumen-ejecutivo.md) |
| Ver el diagnóstico completo | [`diagnostico/diagnostico-integral.md`](diagnostico/diagnostico-integral.md) |
| Conocer los principios rectores | [`principios/principios-generales.md`](principios/principios-generales.md) |
| Leer un pilar específico | [`pilares/`](pilares/) |
| Ver una ficha ministerial | [`fichas-tecnicas/`](fichas-tecnicas/) |
| Ver el plan 0–36 meses | [`implementacion/plan-implementacion-0-36-meses.md`](implementacion/plan-implementacion-0-36-meses.md) |
| Comisión Carmen Navas (verdad + memoria) | [`implementacion/comision-carmen-navas-verdad-memoria.md`](implementacion/comision-carmen-navas-verdad-memoria.md) |
| Consultar el texto articulado | [`articulado/texto-articulado-clausula-continuidad.md`](articulado/texto-articulado-clausula-continuidad.md) |
| Documento final compilatorio | [`documento/documento-final-v0.1.md`](documento/documento-final-v0.1.md) |
| Marco comparativo internacional | [`referencias/marco-comparativo-milei-singapur.md`](referencias/marco-comparativo-milei-singapur.md) |
| Propuesta por dimensión | [`referencias/propuesta-reforma.md`](referencias/propuesta-reforma.md) |
...
## Estado reformado — 12 fichas técnicas ministeriales
...
## Innovaciones arquitectónicas materializadas

1. **Cláusula de continuidad transversal**: blindaje reforzado de las reformas estructurales con mayoría de tres quintos de la Asamblea Nacional más referéndum aprobatorio con 80 % del padrón electoral. Aplica a la regla *pay-before-take* constitucionalizada (26-jul-2026) y al Título IX-A MIED-LAM. El poder constituyente derivado **no puede abolir garantía fundamental** sin cumplir el procedimiento reforzado. Límite absoluto contra reversiones autoritarias.

2. **Veeduría Internacional Permanente**: panel mixto de la Oficina del Alto Comisionado de las Naciones Unidas para los Derechos Humanos + Comisión Interamericana de Derechos Humanos + Alto Comisionado de las Naciones Unidas para los Refugiados + Agencia Europea de la Guardia de Fronteras y Costas + Organización Internacional de Policía Criminal, durante 8 años, con poder de investigación trimestral vinculante en CPNP, CICPC, JNEM, DNPEP, FAN.

3. **VePass-Firma obligatoria** en todos los actos del CPNP, CICPC, JNEM, DNA-RB, DNPEP, CNSC, MIED-LAM — "vigilancia sobre la vigilancia". Cubre aproximadamente 250.000 actos/mes en el régimen de pleno funcionamiento.

4. **LORAFEE *pay-before-take* 90 días + rango constitucional** (reforma del 26-jul-2026): el Estado no toma el control de las acciones hasta haber pagado el 100 %. Reversión automática si incumple, con responsabilidad patrimonial. La garantía más fuerte contra la expropiación indirecta; constitucionalizada para impedir su reversión clientelar.

5. **Régimen de Tres Exámenes Rigurosos** para cuerpos preexistentes — sin presunción de idoneidad sobre los efectivos previos. Tres exámenes consecutivos con reexaminación periódica cada 5 años.

6. **Comisión Carmen Navas de Verdad, Memoria y Reparación**: mecanismo ejecutivo de revisión de expedientes con lista nominada vinculante al Ejecutivo y plazos de 60 días, más habeas corpus colectivo si incumplimiento. Análoga a la Comisión de la Verdad de Brasil pero con poder ejecutivo vinculante.

7. **Plan Quinquenal vinculante** + Presupuesto Plurianual 3 años + rating anual A–D público de planes y programas (modelo Sistema Nacional de Inversiones de Chile + UK HM Treasury Green Book).

8. **Trazabilidad fetal que cierra el fraude**: el Banco Nacional de Datos retiene 75 años el perfil de ADN de todo óbito fetal. Ningún nacido vivo puede coincidir con ese perfil sin orden judicial previa, y el intento fraudulento deja huella indeleble — cierra el ciclo de robo de niños para tráfico y trata.

9. **Poder Ciudadano ampliado** (Innovación arquitectónica #9, 25-jul-2026): la Comisión Nacional del Servicio Civil y la Dirección Nacional Anticorrupción y Recuperación de Bienes pasan al Poder Ciudadano, no a un Ministerio del Ejecutivo. Blindaje contra motosierra sucesoria: cada gobierno de turno no puede vaciar meritocracia ni capturar anticorrupción.
...
| H9 | Anexos: inventarios ministeriales 2009 + 2026 | 2026-07-25 |
| H10 | 12 fichas técnicas (9 ministerios + Defensa + Poder Ciudadano) | 2026-07-25 |
| H10 patch | Pay-before-take constitucionalizada + SM USD 512 + presupuesto FAN 1,9 % + INGEOMIN | 2026-07-26 |
