...
clausula_continuidad: "3/5 AN + referéndum aprobatorio con 80% del padrón electoral (Innovación #1, elevada 2026-07-26) — pay-before-take constitucionalizada (Arts. 344+348 CRBV)"
...
**Adscripción**: 2 ministerios vigentes (Hidrocarburos + Desarrollo Minero Ecológico) + CVG + Pequiven + filiales privatizables.
...
**Régimen LORAFEE** (adquisición forzosa): cláusula pay-before-take 90 días con reversión automática. Es el cierre de la "trampa expropiadora" histórica: el Estado NO toma control hasta haber pagado el 100%, y si incumple el pago, las acciones regresan al accionista privado originario, con responsabilidad patrimonial. **Elevada a rango constitucional** mediante reforma CRBV (Arts. 344+348): la regla pay-before-take con reversión automática deja de ser una mera previsión legal de la LORAFEE y se incorpora al texto constitucional como cláusula pétrea blindada. Procedimiento de reforma constitucional reforzado: **3/5 de los miembros de la Asamblea Nacional + ratificación mediante referéndum aprobatorio con el 80% del padrón electoral** (umbral de legitimación muy superior al estándar del Art. 348, que solo exige mayoría simple de votantes; la sobre-mayoría del 80% del padrón garantiza que la cláusula sólo pueda ser modificada por una mayoría social amplísima, blindándola contra capturas coyunturales).

**Vinculación internacional**:
- Fondos soberanos objetivo (Norwegian GPFG, GIC Singapur, ADIA Abu Dhabi, Temasek, Mubadala, PIF Saudi)
...
│   │   ├── Dirección General de Catastro Minero y Geología (INGEOMIN)
...
- Aplica régimen LOH y sus reglamentos; emite autorizaciones de exploración; supervisa contratos de operación; aplica sanciones.
...
- Aplicación de la LOM y régimen conexo de siderurgia.
...
- **INGEOMIN — adscripción**: Dirección General de Catastro Minero y Geología. Funciones: catastro minero nacional (inscripción, vigencia, fiscalización de concesiones mineras metálicas y no metálicas), cartografía geológica 1:100.000 / 1:250.000, evaluación de recursos minerales metálicos y no metálicos, control técnico de la pequeña minería (régimen simplificado, formación técnica, fiscalización liviana), fiscalización geológica de la mediana y gran minería (cumplimiento de planes de exploración, programa de inversiones, recuperación ambiental), peritaje técnico en controversias LORAFEE cuando involucre valoración de reservas.
...
**Total entes**: 6 dentro del tope de 40 (Art. 9 Texto Articulado).

> **Entes suprimidos o transferidos**: DGCIM (a suprimir/desactivación de funciones civiles — transferida al ente Defensa presidencial Consejo Nacional de Defensa), PDVSA Operaciones (fusionada en PETROVEX S.A.), BANDES / Banco del Tesoro (transferidos al Ministerio de Economía y Finanzas), BANCOEX / BANFOANDES (cerrados), Tareacero (subsumido en PETROVEX), FERROMINERA DEL ORINOCO (privatizada 49% + 51% estatal con golden share), Minerven, CVG Carbón, C.A. Electricidad de Caracas, CADAFE, ENELBAR, EDELCA, Cuerpoelec, Corpoelec-G, Corpoelec-D (transferidos al Ministerio de Infraestructura y Servicios #5 para privatización 100%), Pequiven, Pecom (revistos en CVG/Pequiven de este ministerio).
...
1. Auto de inicio: Procurador General o BCV (según la causal).
