...
Cada ficha sigue una estructura operativa canónica:

1. **Resumen ejecutivo**: adscripción ministerial, objetivo central, masa crítica de regulación, vinculación internacional, mandato constitucional literal.
2. **Marco constitucional y legal**: reformas CRBV requeridas (Arts. 156, 184, 236, 302, 303, 312, 314, 332-333, 343-348, etc.), leyes orgánicas nuevas (LORAFEE, LOBCV, LOPSEP, etc.) y reformas a leyes vigentes (LOH, LOM, LOAFSP, COT, etc.).
3. **Estructura orgánica**: organigrama del Despacho del Ministro con Viceministerios y Direcciones Generales; en algunos casos incluye Direcciones especiales (Catastro Minero, VePass-Firma, Patrimonio Cultural, etc.).
4. **Entes adscritos**: tabla de los 3-6 entes del tope de 40 (Art. 9 Texto Articulado) con naturaleza jurídica, tipo y origen.
...
12. **Cláusula de continuidad reforzada**: blindaje constitucional de las reformas estructurales; procedimiento de modificación (3/5 AN + referéndum aprobatorio 80 % padrón electoral para los ministerios con garantía reforzada).
13. **Innovaciones arquitectónicas materializadas**:Innovación #1, #3, etc., que se hacen operativas en este ministerio.
14. **Documentos conexos**: pilares + leyes orgánicas + fichas técnicas relacionadas.
